...
const { createProduct, getallProduct, getInternationaljersey, getClubjersey, getLocaljersey, getProductDetail, searchProduct, getuser, updateProduct, deleteProduct } = require("../controllers/productController");
